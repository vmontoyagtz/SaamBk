...
{
    public class MessageDocument : BaseEntityEv<int>, IAggregateRoot
    {
        private MessageDocument() { } // EF required

        //[SetsRequiredMembers]
        public MessageDocument(Guid documentId, Guid documentTypeId, Guid messageId, Guid tenantId)
        {
